...
def search():
    ...
    for i in my_cursor:
        ...
        date = f"{d}/{m}/{y}"
        customer_name_value.set(f"{i[1]}")
        exporter_name_value.set(f"{i[2]}")
        received_by_value.set(f"{i[3]}")
        date_value.set(f"{date}")
        owner1_value.set(f"{i[5]}")
        quantity1_value.set(f"{i[6]}")
        weight1_value.set(f"{i[7]}")
        rate1_value.set(f"{i[8]}")
        amount1_value.set(f"{i[9]}")
        owner2_value.set(f"{i[10]}")
        quantity2_value.set(f"{i[11]}")
        weight2_value.set(f"{i[12]}")
        rate2_value.set(f"{i[13]}")
        amount2_value.set(f"{i[14]}")
        owner3_value.set(f"{i[15]}")
        quantity3_value.set(f"{i[16]}")
        weight3_value.set(f"{i[17]}")
        rate3_value.set(f"{i[18]}")
        amount3_value.set(f"{i[19]}")
        owner4_value.set(f"{i[20]}")
        quantity4_value.set(f"{i[21]}")
        weight4_value.set(f"{i[22]}")
        rate4_value.set(f"{i[23]}")
        amount4_value.set(f"{i[24]}")
        owner5_value.set(f"{i[25]}")
        quantity5_value.set(f"{i[26]}")
        weight5_value.set(f"{i[27]}")
        rate5_value.set(f"{i[28]}")
        amount5_value.set(f"{i[29]}")
        total_value.set(f"{i[30]}")
        fare_value.set(f"{i[31]}")
        received_value.set(f"{i[32]}")
        due_value.set(f"{i[33]}")
